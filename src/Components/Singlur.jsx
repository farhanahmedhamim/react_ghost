...
function Singlur(props) {
    return (
        <div className="bannerwrap hamim" style={{ backgroundImage: `linear-gradient(0deg, #0000008c, #0000008c), url(${props.val.img})` }}>
